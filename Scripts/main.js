...
var MSOEBox = Item.extend({
	init: function(x, y, level, amount) {
		this._super(x, y, true, level);
		this.setImage(images.objects, 1024, 714);
		this.setAmount(amount || 1);
	},
	setAmount: function(amount) {
		this.items = [];
	...
	activate: function(from) {
		if(!this.isBouncing) {
			if(this.items.length) {
				...
				el = document.getElementById("msoe-overlay");
				el.style.visibility = (el.style.visibility == "visible") ? "hidden" : "visible";

				this.actors.push(coin);

				if(!this.items.length) {
					this.setImage(images.objects, 1058, 714);
...
var MultipleMSOEBox = MSOEBox.extend({
	init: function(x, y, level) {
		this._super(x, y, level, 2);
	},
}, 'multiple_msoebox');
...
var ZenithBox = Item.extend({
	init: function(x, y, level, amount) {
		this._super(x, y, true, level);
		this.setImage(images.objects, 1024, 782);
		this.setAmount(amount || 1);
	},
	setAmount: function(amount) {
		this.items = [];
	...
	activate: function(from) {
		if(!this.isBouncing) {
			if(this.items.length) {
				...
				el = document.getElementById("zenith-overlay");
				el.style.visibility = (el.style.visibility == "visible") ? "hidden" : "visible";

				this.actors.push(coin);

				if(!this.items.length) {
					this.setImage(images.objects, 1058, 782);
...
var MultipleZenithBox = ZenithBox.extend({
	init: function(x, y, level) {
		this._super(x, y, level, 2);
	},
}, 'multiple-zenithbox');
...
/*
 * -------------------------------------------
 * Rockwell Automation CLASS
 * -------------------------------------------
 */

var RABox = Item.extend({
	init: function(x, y, level, amount) {
		this._super(x, y, true, level);
		this.setImage(images.objects, 1024, 678);
		this.setAmount(amount || 1);
	},
	setAmount: function(amount) {
		this.items = [];
	...
	activate: function(from) {
		if(!this.isBouncing) {
			if(this.items.length) {
				...
				el = document.getElementById("ra-overlay");
				el.style.visibility = (el.style.visibility == "visible") ? "hidden" : "visible";

				this.actors.push(coin);

				if(!this.items.length) {
					this.setImage(images.objects, 1058, 678);
...
var MultipleRABox = RABox.extend({
	init: function(x, y, level) {
		this._super(x, y, level, 2);
	},
}, 'multiple-rabox');
...
var MotoBox = Item.extend({
	init: function(x, y, level, amount) {
		this._super(x, y, true, level);
		this.setImage(images.objects, 956, 678);
		this.setAmount(amount || 1);
	},
	setAmount: function(amount) {
		this.items = [];
	...
	activate: function(from) {
		if(!this.isBouncing) {
			if(this.items.length) {
				...
				el = document.getElementById("moto-overlay");
				el.style.visibility = (el.style.visibility == "visible") ? "hidden" : "visible";

				this.actors.push(coin);

				if(!this.items.length) {
					this.setImage(images.objects, 990, 678);
...
var MultipleMotoBox = MotoBox.extend({
	init: function(x, y, level) {
		this._super(x, y, level, 2);
	},
}, 'multiple-motobox');
...
var EricssonBox = Item.extend({
	init: function(x, y, level, amount) {
		this._super(x, y, true, level);
		this.setImage(images.objects, 956, 712);
		this.setAmount(amount || 1);
	},
	setAmount: function(amount) {
		this.items = [];
	...
	activate: function(from) {
		if(!this.isBouncing) {
			if(this.items.length) {
				...
				el = document.getElementById("ericsson-overlay");
				el.style.visibility = (el.style.visibility == "visible") ? "hidden" : "visible";

				this.actors.push(coin);

				if(!this.items.length) {
					this.setImage(images.objects, 990, 712);
...
var MultipleEricssonBox = EricssonBox.extend({
	init: function(x, y, level) {
		this._super(x, y, level, 2);
	},
}, 'multiple-ericssonbox');
...
var CoxBox = Item.extend({
	init: function(x, y, level, amount) {
		this._super(x, y, true, level);
		this.setImage(images.objects, 956, 747);
		this.setAmount(amount || 1);
	},
	setAmount: function(amount) {
		this.items = [];
	...
	activate: function(from) {
		if(!this.isBouncing) {
			if(this.items.length) {
				...
				el = document.getElementById("cox-overlay");
				el.style.visibility = (el.style.visibility == "visible") ? "hidden" : "visible";

				this.actors.push(coin);

				if(!this.items.length) {
					this.setImage(images.objects, 990, 747);
...
var MultipleCoxBox = CoxBox.extend({
	init: function(x, y, level) {
		this._super(x, y, level, 2);
	},
}, 'multiple-coxbox');
...
var TylerBox = Item.extend({
	init: function(x, y, level, amount) {
		this._super(x, y, true, level);
		this.setImage(images.objects, 956, 782);
		this.setAmount(amount || 1);
	},
	setAmount: function(amount) {
		this.items = [];
	...
	activate: function(from) {
		if(!this.isBouncing) {
			if(this.items.length) {
				...
				el = document.getElementById("tyler-overlay");
				el.style.visibility = (el.style.visibility == "visible") ? "hidden" : "visible";

				this.actors.push(coin);

				if(!this.items.length) {
					this.setImage(images.objects, 990, 782);
...
var MultipleTylerBox = TylerBox.extend({
	init: function(x, y, level) {
		this._super(x, y, level, 2);
	},
}, 'multiple-tylerbox');
...
var BrenauBox = Item.extend({
	init: function(x, y, level, amount) {
		this._super(x, y, true, level);
		this.setImage(images.objects, 1024, 747);
		this.setAmount(amount || 1);
	},
	setAmount: function(amount) {
		this.items = [];
	...
	activate: function(from) {
		if(!this.isBouncing) {
			if(this.items.length) {
				...
				el = document.getElementById("brenau-overlay");
				el.style.visibility = (el.style.visibility == "visible") ? "hidden" : "visible";

				this.actors.push(coin);

				if(!this.items.length) {
					this.setImage(images.objects, 1058, 747);
...
var MultipleBrenauBox = BrenauBox.extend({
	init: function(x, y, level) {
		this._super(x, y, level, 2);
	},
}, 'multiple-brenaubox');
